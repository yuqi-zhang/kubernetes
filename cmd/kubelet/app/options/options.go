...
type KubeletFlags struct {
	...
	// kubeletDropinDir is a path to a directory to specify dropins allows the user to optionally specify
	// additional configs to overwrite what is provided by default and in the KubeletConfigFile flag
	KubeletDropinDir string
...
func (f *KubeletFlags) AddFlags(mainfs *pflag.FlagSet) {
	...
	fs.StringVar(&f.KubeletDropinDir, "config-dir", f.KubeletDropinDir, "Path to a directory to specify dropins, allows the user to optionally specify additional configs to overwrite what is provided by default and in the KubeletConfigFile flag")
